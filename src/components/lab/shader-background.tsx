...
/** FOLIO lab palettes — adapted from 21st.dev Shader Builder Plasma (id 24346). */
export type ShaderLabVariant = "ink-ledger" | "ledger-mist" | "aurora-grid"
...
export function ShaderBackground({
  ...
  className?: string
  variant?: ShaderLabVariant
}) {
  const canvasRef = useRef<HTMLCanvasElement>(null)

  useEffect(() => {
    const UNIFORMS = VARIANTS[variant]
